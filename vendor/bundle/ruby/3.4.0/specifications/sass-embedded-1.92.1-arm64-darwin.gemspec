# -*- encoding: utf-8 -*-
# stub: sass-embedded 1.92.1 arm64-darwin lib

Gem::Specification.new do |s|
  s.name = "sass-embedded".freeze
  s.version = "1.92.1".freeze
  s.platform = "arm64-darwin".freeze

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.metadata = { "bug_tracker_uri" => "https://github.com/sass-contrib/sass-embedded-host-ruby/issues", "documentation_uri" => "https://rubydoc.info/gems/sass-embedded/1.92.1", "funding_uri" => "https://github.com/sponsors/ntkme", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/sass-contrib/sass-embedded-host-ruby/tree/v1.92.1" } if s.respond_to? :metadata=
